...
Cuestionarios Dinámicos: Evalúa tu conocimiento de gramática y vocabulario de cada tema con cuestionarios interactivos.

Seguimiento del Progreso: Registra tu avance en cada lección para que puedas ver tu desarrollo en el idioma.
...
JavaScript (Puro): Para toda la lógica de la aplicación y la interactividad del cuestionario.

Supabase: Como back-end para la autenticación de usuarios y la gestión de la base de datos de lecciones y progreso.

Font Awesome: Para los íconos utilizados en la interfaz de usuario.
